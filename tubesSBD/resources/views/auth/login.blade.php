    ...
    <div class="flex min-h-screen bg-white">
        ...
        <div class="w-full lg:w-[60%] flex flex-col relative px-8 py-10 sm:px-16 md:px-24">
            ...
            <div class="flex-1 flex flex-col justify-center items-center w-full max-w-sm mx-auto">
                ...
                <!-- Tombol Google Login -->
                <button type="button" class="w-full flex items-center justify-between px-4 py-3 mb-6 border border-gray-300 rounded-full hover:bg-gray-50 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    <div class="flex items-center gap-3">
                        <!-- Dummy Avatar -->
                        <div class="w-8 h-8 rounded-full bg-orange-200 overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Tabhita&background=fbd38d&color=8c3000" alt="Avatar" class="w-full h-full object-cover">
                        </div>
                        <div class="flex flex-col text-left">
                            <span class="text-sm font-semibold text-gray-900">Lanjutkan sebagai Tabhita</span>
                            <span class="text-xs text-gray-500">tabhitasilitonga@gmail.com</span>
                        </div>
                    </div>
                    <!-- Ikon Google -->
